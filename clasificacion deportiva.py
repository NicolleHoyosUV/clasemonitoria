def hello():
    inicio = 'Clasificacion de resultados competencia.'
    return inicio
...
def puntaje_mayor(nombre_equipo):
    ...
    persona_mas_alto = ""
    i = 0
    while(i<cantidad_participantes):
        personaje = input("Ingresa el nombre del participante: ")
    ...
    return puntos_totales(f"La persona con más puntos fue {persona_mas_alto} del equipo {nombre}")
